...
class OtfVerificationPage extends StatefulWidget {
  const OtfVerificationPage({super.key});

  @override
  State<OtfVerificationPage> createState() => _OtfVerificationPageState();
}

class _OtfVerificationPageState extends State<OtfVerificationPage> {
  @override
